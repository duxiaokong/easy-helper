...
if (!function_exists('easy_bcadd')) {
     ...
     * @return string
     */
    function easy_bcadd($left_operand, $right_operand, $scale = 14)
    {
...
if (!function_exists('easy_bcsub')) {
     ...
     * @return string
     */
    function easy_bcsub($left_operand, $right_operand, $scale = 14)
    {
...
if (!function_exists('easy_bcmul')) {
     ...
     * @return string
     */
    function easy_bcmul($left_operand, $right_operand, $scale = 14)
    {
...
if (!function_exists('easy_bcdiv')) {
     ...
     * @return string
     */
    function easy_bcdiv($left_operand, $right_operand, $scale = 14)
    {
...
if (!function_exists('easy_bccomp')) {
     ...
     * @return int
     */
    function easy_bccomp($left_operand, $right_operand, $scale = 10)
    {
...
if (!function_exists('easy_bc')) {
     ...
     * @return string
     */
    function easy_bc($left_operand, $right_operand, $scale = 10, $method = 'bcadd')
    {
